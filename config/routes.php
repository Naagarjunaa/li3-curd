...
Router::connect('/todos', ['controller' => 'todos', 'action' => 'index']);
Router::connect('/todos/add', ['controller' => 'todos', 'action' => 'add']);
Router::connect('/todos/{:id}/edit', ['controller' => 'todos', 'action' => 'edit']);
Router::connect('/todos/{:id}/show', ['controller' => 'todos', 'action' => 'show']);
Router::connect('/todos/{:id}/delete', ['controller' => 'todos', 'action' => 'remove']);
Router::connect('/add-todo',  ['controller' => 'todos', 'action' => 'add_todo']);
Router::connect('/edit-todo',  ['controller' => 'todos', 'action' => 'update_todo']);
...
// Router::connect('/todo', 'Todos::index');
